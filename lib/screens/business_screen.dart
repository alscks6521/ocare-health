                ...
                children: [
                  Container(
                    ...
                    child: PageView.builder(
                      itemCount: (chatState.items.length / 3).ceil(),
                      itemBuilder: (context, index) {
                        int startIndex = index * 3;
                        int endIndex = (index + 1) * 3;
                        if (endIndex > chatState.items.length) endIndex = chatState.items.length;

                        return Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: List.generate(endIndex - startIndex, (itemIndex) {
                            return NutritionalContainer(
                              nutritionalItem: chatState.items[startIndex + itemIndex],
                            );
                          }),
                        );
                      },
