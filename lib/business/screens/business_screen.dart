...
import 'nutritional_dialog.dart';
...
class _BusinessScreenState extends State<BusinessScreen> {
  ...
  Future<void> _recomNutritional() async {
    const FOOD_API = '17deaf4a8c9944a09816';
    // 증상
    var url =
  ...
  Future<void> _sendMessage() async {
    ...
    // const OPENAI_API = 'sk-proj-oir3cuIOvyKWxcGkV8xbT3BlbkFJkfVal9QnuJ8HbuxYuqn2';
    const OPENAI_API = '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';

    final response = await http.post(
      Uri.parse('https://api.openai.com/v1/chat/completions'),
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer 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', // Use your actual API key
      },
      body: jsonEncode({
        'model': 'gpt-3.5-turbo',
        'messages': [
